...
diabetes_rec1 = recipe(Diabetes_binary ~ BMI + Age + PhysActivity, data = diabetes_train) %>%
  step_normalize(all_numeric(), -Diabetes_binary)

diabetes_rec2 = recipe(Diabetes_binary ~ BMI + Age + PhysActivity + HighBP, data = diabetes_train) %>%
  step_normalize(all_numeric(), -Diabetes_binary)

diabetes_rec3 = recipe(Diabetes_binary ~ BMI + Age + PhysActivity + HighChol + HighBP, data = diabetes_train) %>%
  step_normalize(all_numeric(), -Diabetes_binary)
```
